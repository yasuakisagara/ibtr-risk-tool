...
if lang == "日本語":
    st.markdown("""
### クレジット
本ツールは、第29回日本乳癌学会班研究（班長：坂井威彦）による多施設研究に基づいて開発されました。モデルの設計およびウェブアプリの実装は、相良安昭により主に行われました。

© 日本乳癌学会 第29回研究班  
出典を明記した上での学術・教育目的での引用・共有を歓迎します。無断の商用利用や改変はご遠慮ください。

### フィードバックのお願い
本ツールに関するご意見や不具合のご報告などがありましたら、以下のフォームよりお寄せください（任意です）。いただいた内容は今後の改良や学術的評価の参考にさせていただきます。
